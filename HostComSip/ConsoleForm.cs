        ...
        static async void UploadAbsensiMasuk()
        {
...

            {
                ...
                foreach (DataRow baris in dt.Rows)
                {
                    ...
                    {
                        client.BaseAddress = new Uri("http://35.190.172.58:"+port+"/api/absen/insert");
                        ...
                        var response = client.PostAsync("http://35.190.172.58:" + port + "/api/absen/insert", content).Result;
...

            {
                ...
                foreach (DataRow baris in dt.Rows)
                {
                    ...
                    using (HttpClient client = new HttpClient())
                    {
                        ...
                        var response = await client.PostAsync("http://35.190.172.58:" + port + "/api/absen/insert", content);
